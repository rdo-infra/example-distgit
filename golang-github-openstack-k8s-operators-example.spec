...
# Uncomment once https://gitlab.com/redhat/centos-stream/rpms/go-rpm-macros/-/merge_requests/10
# is merged and shipped. The macros use golist binary to discover the requires but the PATH
# is wrong, so golist is not found currently.
# https://issues.redhat.com/browse/RHEL-7367
